...
public class SensorReader { 
  ...
  public SensorReader(PApplet processing, String serialPortName) { 
    r = 0; 
    g = 0; 
    b = 0; 
    temperature = 0; 
  ...
  public void update() { 
    ...
    //  try {
    //    p5.println("sending test...");
    //    sensorSerialPort.write("t");
    //    connected = true;
    //  } 
    //  catch (RuntimeException e) { 
    //    p5.println("ERROR - failed to write to serial, reconnecting..."); 
  ...
  public boolean serialEvent(Serial port) { 
    ...
    //try { 
      if(port.available()>0) 
         inByte = port.read();
    //} catch(RuntimeException e) { 
    //   p5.println("Serial not connected"); 
    //   return false; 
    //}
