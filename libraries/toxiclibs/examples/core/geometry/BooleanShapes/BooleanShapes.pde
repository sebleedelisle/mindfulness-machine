...
void draw() {
  background(160);
  BooleanShapeBuilder builder = new BooleanShapeBuilder(BooleanShapeBuilder.Type.XOR);
  ...
  //builder.addShape(Triangle2D.createEquilateralFrom(new Vec2D(50 + sin(phi * 15 / 13) * 50, 200), new Vec2D(300, 200)));
  //builder.addShape(new Circle(100, 300, 50 + 30 * sin(phi * 21 / 15)).toPolygon2D(6));
